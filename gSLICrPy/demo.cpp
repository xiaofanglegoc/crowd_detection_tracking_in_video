...
void CUDA_gSLICr(unsigned char* image,
    ...
    cout << "\n image size is "<< my_settings.img_size.x*my_settings.img_size.y;
	...
	sprintf(__out_name__, "%s.txt", out_name);
	gSLICr_engine->Write_Seg_Res_To_TXT(__out_name__);
    //return boundry_draw_frame;
}
